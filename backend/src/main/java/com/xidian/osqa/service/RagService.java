...
public class RagService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            7. 引用课程内容时，用"第X章"或"第X节"来引用，例如"根据第3章进程管理中的描述"。
    ...
    private static final String WEB_SEARCH_PROMPT = """
            ...
            8. 引用课程内容时，用"第X章"或"第X节"来引用，例如"根据第3章进程管理中的描述"。
        ...
        try {
            ...
            if (!relevantChunks.isEmpty()) {
                ...
                if (webSearch) {
                    ...
                    contextBuilder.append("注意：课程知识库中未检索到与问题直接相关的内容。");
                    contextBuilder.append("请基于操作系统通用知识谨慎回答，并明确告知学生此回答未引用课程原文，建议开启联网搜索或咨询老师。\n\n");
                }
            }
